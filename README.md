...
| FORWARD_MEILISEARCH_PORT  | A port meilisearch is available at for external connections                                                                          | 7700                    | 7700                    |
| MEILI_MASTER_KEY          | A master key used to access Meilisearch API                                                                                          | secure string           | secure string           |
